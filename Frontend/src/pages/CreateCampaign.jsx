            ...
            <div className="bg-white/90 backdrop-blur-md shadow-2xl p-6 md:p-8 rounded-2xl border border-[#00B5B8]/30">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {formData.zakatEligible && (
                  <div className="bg-[#E6F5F3] rounded-xl border border-[#00B5B8]/20 p-4 space-y-4">
                    <div>
                      <label className="block font-semibold text-[#003D3B] mb-2">
                        Zakat Category *
                      </label>
                      ...
                      >
                        ...
                        <option value="poor">Poor - Those who have insufficient wealth</option>
                        <option value="needy">Needy - Those in extreme need</option>
                        <option value="debtors">Debtors - Those in debt</option>
                        <option value="wayfarers">Wayfarers - Travelers in need</option>
                        <option value="new_muslims">New Muslims - New converts</option>
                        <option value="cause_of_allah">Cause of Allah - For Islamic causes</option>
                      </select>
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                      <div className="flex items-start gap-2">
                        ...
                        />
                        <label className="text-sm font-semibold text-[#003D3B]">
                          I affirm that all information provided is truthful and accurate according to Islamic principles. 
